...
function AdminAllProjectsCard(props){
    ...
    const deleteDBRow = (id) => {
      axios.delete(`${process.env.REACT_APP_URL}${props.props.api_option}/${id}`, {
        headers : {
          ...
          navigate("/admin/projects/all", { state : {
            message : `Past Project Deleted`
        }})
        ...
        window.location.reload(false)
          ...
          navigate("/admin/projects/all", { state : {
            message : `Past Project NOT Deleted`
        }})
        window.location.reload(false)
        })
    }
                ...
                <div className="col-10">
                    <Card className="shadow mt--300">
                        ...
                        <CardBody>
                            ...
                            <Row>
                                <Col>
                                <NavLink href={`/admin/${props.props.api_option}/create`}><button className={`btn btn-outline-primary btn-block`}>{`Create new Project`}</button></NavLink>
                                </Col>
                            </Row>
